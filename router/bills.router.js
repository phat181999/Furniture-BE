...
const { createBill,getBills,changeStatus ,getAllBills} = require('../controller/bills.controller');
...
billsRouter.get('/get-orders',authenticate,authorize(['admin']),getAllBills);  
